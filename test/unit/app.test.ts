...
//  */
// test.cb("App should build without errors", t => {
...
//  */
// test.cb("App should start in dev environment", t => {
...
//  */
// test.cb("App should start in production environment", t => {
...
//  */
// test.cb("App should throw error with invalid settings", t => {
